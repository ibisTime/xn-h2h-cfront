...
var selToID = 'U11111111111111113'; // 当前选中聊天id（当聊天类型为私聊时，该值为好友帐号，否则为群号）
...
export function onSendMsg() {
  // const selToID = 'U11111111111111113';
  if (!selToID) {
    alert('你还没有选中好友或者群组，暂不能聊天');
    return;
  }
  // 获取消息内容
  let msgContent = document.getElementsByClassName('msgedit')[0].value;
...
function handleMsgSend(msgContent) {
  ...
  let msg = new webim.Msg(selSess, isSend, seq, random, msgTime, 'U11111111111111112', subType);
